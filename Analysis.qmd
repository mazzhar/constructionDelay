...
format: 
  pdf:
    toc: true
    date: "Last Updated: `r format(Sys.time(), '%F')`"
...
: Table 1: Overview of the work experience distribution among study participants.

Figure 1 shows the work experience distribution of the study participants, color-coded by their profession

![Figure 1: Work experience distribution by profession of the study participants.](work-experience-distribution-by-profession.png)

![Figure 2: Distribution of professions in this study.](distribution-of-professions.png){fig-align="center"}

![Figure 3: Preliminary analysis of responses of the participants.](distribution-of-responses-by-profession.png)

## Likert-Scale

![Figure 4: Likert plot of the responses](likert-plot.jpg)
...
![Figure 5: Visual Element of Factor Loadings of Survey Questions](factor-loadings-of-survey-questions.png){fig-align="center"}
